import { u as useThemeUI, j as jsx$1, C as Context, T as ThemeContext, g as get$3, m as merge$1, G as Global, c as css$2, w as withEmotionCache, a as getRegisteredStyles, s as serializeStyles, b as insertStyles, i as index, d as ThemeProvider, e as memoize, k as keyframes } from './common/is-prop-valid.browser.esm-88134ee1.js';
import './common/_commonjsHelpers-eb5a497e.js';
import { r as react, o as objectAssign } from './common/index-e4252562.js';
...
var applyColorMode = function (theme, mode) {
  ...
  var modes = get$3(theme, 'colors.modes', {});
  return merge$1.all({}, theme, {
    colors: get$3(modes, mode, {})
  });
};

var BodyStyles = function () { return jsx$1(Global, {
...
var tags$1 = ['p', 'b', 'i', 'a', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'img', 'pre', 'code', 'ol', 'ul', 'li', 'blockquote', 'hr', 'em', 'table', 'tr', 'th', 'td', 'em', 'strong', 'del', // mdx
...
var themed = function (key) { return function (props) { return css$2(get$3(props.theme, ("styles." + key)))(props.theme); }; };
var Styled = newStyled('div')(themed('div'));
var components = {};
...
var css = function (args) {
  return function (props) {
    ...
    for (var key in styles) {
      ...
      var prop = get(aliases$1, key, key);
...
var BodyStyles$1 = function () { return jsx$1(Global, {
...
var ThemeProvider$1 = function (ref) {
  ...
  return jsx$1(ThemeProvider, {
    theme: theme
  }, jsx$1(ColorModeProvider, null, jsx$1(BodyStyles$1), jsx$1(MDXProvider$1, {
    components: components,
    children: children
  })));
};
...
var sx = function (props) { return css$2(props.sx)(props.theme); };

var base = function (props) { return css$2(props.__css)(props.theme); };

var variant$1 = function (ref) {
  var theme = ref.theme;
  var variant = ref.variant;
  var __themeKey = ref.__themeKey; if ( __themeKey === void 0 ) __themeKey = 'variants';

  return css$2(get$3(theme, __themeKey + '.' + variant, get$3(theme, variant)));
};
...
var Box = newStyled('div', {
  ...
  margin: 0,
  minWidth: 0
}, base, variant$1, space, color, sx, function (props) { return props.css; });
...
var MRE = /^m[trblxy]?$/;
var getMargin$1 = getProps(function (k) { return MRE.test(k); });
...
var Select = react.forwardRef(function (props, ref) { return react.createElement( Box, Object.assign({}, getMargin$1(props), { sx: {
  display: 'flex'
} }),
...
var Field = react.forwardRef(function (ref$1, ref) {
  ...
  return react.createElement( Box, getMargin$1(props),
...
export { Label, Radio, ThemeProvider$1 as ThemeProvider };
